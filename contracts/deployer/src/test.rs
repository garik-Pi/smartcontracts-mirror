...
fn test() {
    ...
    let out = client.hello(&soroban_sdk::String::from_str(&env, "Dev"));
    assert_eq!(out, soroban_sdk::vec![&env,soroban_sdk::String::from_str(&env, "Hello"), soroban_sdk::String::from_str(&env, "Dev")]);
}